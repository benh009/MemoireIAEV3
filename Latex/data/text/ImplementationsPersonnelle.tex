...
si le code QR se trouve à droite du robot, la formule devient et $\rho$ est négatif:
...
$$
où $S$ est obtenu grâce à la table de probabilité  de la distribution du Chi Square à deux degrés de liberté. Pour un intervalle de confidence de 95~\% $S = 5.991$.
