...
La partie qui suit décrit plus en profondeur les capteurs et moteurs du kit de base qui sont ceux disponibles pour réaliser ce projet. Les descriptions sont basées sur les informations données par le constructeur. Elles sont dirigées vers le type de données reçues ainsi que la précision des capteurs et des moteurs. Elles sont importantes dans ce mémoire, car elles permettent de mieux connaitre les capteurs et les moteurs à notre disposition. Il est ainsi plus facile de définir les erreurs qui sont propres à ces capteurs.
